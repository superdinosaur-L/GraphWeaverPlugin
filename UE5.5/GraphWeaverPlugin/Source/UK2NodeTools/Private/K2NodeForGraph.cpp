...
void UK2Node_SpawnGraphView::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	CreateView->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, CreateGraphView_NotManuallyCall),UFunctionTools::StaticClass());
	...
	ModViewAttri->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, ModGraphViewBaseAttri_NotManuallyCall), UFunctionTools::StaticClass());
	...
	case 0://NAConstructMethod::Names
		{
			...
			ModViewNaCon->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, ModGraphViewNaCon_NotManuallyCall), UFunctionTools::StaticClass());
			...
			ModViewFinal->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, ModGraphViewFinalPhase_NotManuallyCall), UFunctionTools::StaticClass());
...
void UK2Node_SpawnGraphNode::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	if (IndexOfSourceGraphView == -1)[[unlikely]]
	{
		...
		NonFun->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, NonFunction), UFunctionTools::StaticClass());
	...
	CreateNode->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, CreateGraphNode_NotManuallyCall), UFunctionTools::StaticClass());
	...
	SetNodeOuter->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, SetNodeOuter_NotManuallyCall), UFunctionTools::StaticClass());
	...
	SetRealView->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, SetRealSourceViewForNode_NotManuallyCall), UFunctionTools::StaticClass());
	...
	CallProcessInform->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, CallProcessInformOrNot_NotManuallyCall), UFunctionTools::StaticClass());
	...
	case 0:
		{
			...
			ModNamesInput->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, ModNamesInput_NotManuallyCall), UFunctionTools::StaticClass());
	...
	case 1:
		{
			...
			ModLHCodeInput->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UFunctionTools, ModLHCodeInput_NotManuallyCall), UFunctionTools::StaticClass());
