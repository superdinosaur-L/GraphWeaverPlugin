...
FGraphViewDataCarrier UGraphView::GetViewDataCarrier()
{
	FGraphViewDataCarrier Carrier;
	Carrier.Clans = Clans;
	Carrier.RealNodes = RealNodes;
	Carrier.WillHorizontalAwakeNode = WillHorizontalAwakeNode;
	Carrier.WillVerticalAwakeNode = WillVerticalAwakeNode;
	Carrier.WayToDealSameNode = WayToDealSameNode;
	Carrier.ErrorCodeForConstructView = ErrorCodeForConstructView;
	return Carrier;
}

void UGraphView::ResetViewFromDataCarrier(FGraphViewDataCarrier& DataCarrier)
{
	Clans = DataCarrier.Clans;
	RealNodes = DataCarrier.RealNodes;
	WillHorizontalAwakeNode = DataCarrier.WillHorizontalAwakeNode;
	WillVerticalAwakeNode = DataCarrier.WillVerticalAwakeNode;
	WayToDealSameNode = DataCarrier.WayToDealSameNode;
	ErrorCodeForConstructView = DataCarrier.ErrorCodeForConstructView;
}
